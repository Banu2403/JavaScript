...
1/
// const balance = bankData.map((element) => +element.balance.replace("$", "").replace(',', ''));
// console.log(balance)
// const averageBalance = balance.reduce((accumulator, currentValue) => {
...
2/
  const userAge = bankData.filter((user => user.age === 24));
  console.log(userAge);
  ...
  3/   
  const isActivetrue = bankData.filter((element) => element.isActive === true).map((element) => +element.balance.replace("$", "").replace(',', ''));
  console.log(isActivetrue)
  let max = isActivetrue.reduce((accumulator, currentValue) => {
